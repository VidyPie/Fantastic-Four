...
WHERE o.KomponenterID = kom.KomponenterID AND kom.MotorID = m.MotorID 
AND kom.BatteriID = b.BatteriID AND kom.ESCID = esc.ESCID
AND kom.KontrollbrettID = kon.KontrollbrettID AND kom.PropellID = p.PropellID AND o.OppskriftID = param1;
END;;
